...
Task: Build a machine learning model to predict if an applicant is 'good' or 'bad' client, different from other tasks, the definition of 'good' or 'bad' is not given. 
Тип задачи: Бинарная классификация

Метрика - ROC-AUC
https://colab.research.google.com/drive/1CSu8Eqbqp5Q8f9WKyUqpwEjKovZtKpkG?usp=sharing
